...
app.controller('manual_booking', ['$scope', '$http', '$compile', '$filter', function($scope, $http, $compile, $filter) {
    ...
    $scope.vehicle_detail_no_of_tolls = 0
    $scope.vehicle_detail_toll_cost = 0
    $scope.vehicle_detail_surcharge_amount =0
    scope.vehicle_detail_location_name =''
		...
		date_time=$('#input_date_time').val()
      	$http.post(REQUEST_URL+'/search_cars', {
        	...
        	if (response.status_code==0) {
                ...
                }else if(response.status_message == 'toll_error'){
	...
	function fare_detail()
	{
        ...
        $scope.vehicle_detail_surcharge_amount =$scope.vehicle_detail.surcharge_amount
        $scope.vehicle_detail_location_name =$scope.vehicle_detail.location_name
        ...
        $scope.vehicle_detail_no_of_tolls = $scope.vehicle_detail.no_of_tolls
        $scope.vehicle_detail_toll_cost =$scope.vehicle_detail.toll_cost
