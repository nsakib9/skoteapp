...
Route::get('check_version', 'HomeController@check_version');
...
Route::match(['GET', 'POST'], 'login', 'TokenAuthController@login');
...
Route::get('pickup_point', 'TokenAuthController@pickup_point');
