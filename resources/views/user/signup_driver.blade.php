      ...
      <div class="layout__item layout--join__hero-item soft-gutter z-30" style="padding-top:0 !important;" >
        <div class="layout" style=" margin-left: -40px;"
          ...
          <div class="layout__item driver-signup-form-container" >
            ...
            <div class="layout__item one-whole push-tiny--bottom--legacy" id="pad-sm-right" style="padding:0px;" >
              <div class="_style_3EKecM" >
                {!! Form::text('first_name', '', ['class' => '_style_3vhmZK','placeholder' => trans('Firstname'),'id' => 'fname' ]) !!}
              </div>
        ...
        <div class="top-section-sub clearfix col-md-12" style="margin-top:10px;">
          <div class="col-md-4 col-xs-12 text-center" >
            <div class="top-section-sub-cont" >
              ...
              <div class="sub-top" >
                <h4 >{{trans('User money make content')}}
                </h4>
                <div class="" >
                  <p >{{trans('User money make content',['site_name' => $site_name])}}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-4 col-xs-12 text-center" >
            <div class="top-section-sub-cont" >
              ...
              <div class="sub-top" >
                <h4 >{{trans('User Drive when want')}}
                </h4>
                <div class="" >
                  <p>{{trans('User Drive when want')}} {{$site_name}}, {{trans('User Imp_moments')}}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-4 col-xs-12 text-center" >
            <div class="top-section-sub-cont" >
              ...
              <div class="sub-top" >
                <h4 >{{trans('User no_office')}}
                </h4>
                <div class="" >
                  <p >{{trans('User no_office')}} {{$site_name}} {{trans('User Freedom')}}
                  </p>
                </div>
              </div>
            </div>
