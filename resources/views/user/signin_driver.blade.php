      ...
      <div class="login-wrap p-4 p-lg-5">
          <div class="d-flex">
            ...
            <form class="push--top-small forward" method="POST" data-reactid="13" >
               ...
               <div data-reactid="15" class="email_phone-sec">
                  <h4 data-reactid="14">Sign In Driver</h4>
         ...
         <div class="wrap col-6 p-0">
          ...
          <div class="w-50 text-md-right">
            ...
            <p class=" display--inline email_phone-sec" data-reactid="27">Don't have an account?<a href="{{ url('signup_driver')}}">Sign Up</a></p>
            <p class="pull-right forgot password-sec hide">
               <a href="{{ url('forgot_password_driver')}}" class="forgot-password">Forgot Password ?</a>
            </p>
