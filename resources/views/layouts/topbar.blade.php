    ...
    <div class="navbar-header w-100">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ url($first_segment.'/dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}"
                    alt="Header Avatar">
                <span class="d-none d-xl-inline-block ms-1" key="t-henry">{{ucfirst(!$company_user?$user->username:$user->name)}}</span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    @csrf
                    <input type="hidden" value="{{ !$company_user?$user->id:$user->id }}" id="data_id">
                    <div class="mb-3">
                    ...
                    <div class="mt-3 d-grid">
                        <button class="btn btn-primary waves-effect waves-light UpdatePassword" data-id="{{ !$company_user?$user->username:$user->name }}"
