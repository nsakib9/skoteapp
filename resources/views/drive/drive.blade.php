...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  column-content bor-bot-sm" id="pad-sm-zero" style="padding:0px 120px 0px 0px;">
  ...
  <div class="arrive-content">
<div style="position: relative !important;"><p class="slide-content trip-content how-column-content" style="margin-bottom:10px !important;    ">{{trans('messages.drive.making_money')}}</p>
...
@endif
  ...
  <div class="arrive-content">
<div style="position: relative !important;"><p class="slide-content trip-content how-column-content" style="margin-bottom:10px !important;  ">{{trans('messages.drive.support')}}</p>
