...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1 style="display: inline-block; "> Email Settings </h1>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-danger">
          <div class="card-header shadow p-3 mb-5 bg-body rounded with-border">
            <h3 class="card-title">Email Settings Form</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => 'admin/email_settings', 'class' => 'form-horizontal']) !!}
          <div class="card-body"  ng-init="email_driver='{{ old('driver',$result[0]->value) }}';smtp_username='{{$result[6]->value}}';smtp_password='{{$result[7]->value}}';saved_domain='{{$result[8]->value}}';saved_secret='{{$result[9]->value}}';">
