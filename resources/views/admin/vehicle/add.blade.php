...
<div class="content-wrapper" ng-controller="vehicle_management">
	<section class="content-header">
		...
		<h1 style="display: inline-block; "> Add Vehicles </h1>
	...
	<section class="content">
		<div class="row">
			<div class="col-md-8 offset-2 ne_ed">
				<div class="card card-danger">
					<div class="card-header shadow p-3 mb-5 bg-body rounded with-border">
						<h3 class="card-title">Add Vehicles Form</h3>
					</div>
					...
					<div class="card-body ed_bld">
						...
						<div class="form-group">
							...
							<div class="col-sm-8" ng-init="selectedDriver = '';">
