...
<div class="manual-booking content-wrapper" ng-controller='manual_booking' ng-init="vehicle_types = {{$vehicle_types}}">
	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-3 cls_manualbook" ng-init="country_code={{(@$schedule_ride->users->country_code==null)?$country_code_option[0]->phone_code:@$schedule_ride->users->country_code}}">
			...
			<div class="col-md-8 map-wrap">
				<div class="map-route-option">
					...
					<div class="fare-table clearfix">
						...
						<div class="row">
							<div class="col-md-8">
								Distance ( <span ng-cloak> @{{vehicle_detail_km}} </span> Mile) :
							</div>
							<div class="col-md-4" ng-cloak>
						...
						<div class="row">
							<div class="col-md-8">
								Toll Cost (<span  ng-cloak> No of Tolls - @{{vehicle_detail_no_of_tolls}} </span>) :
							</div>
							<div class="col-md-4" ng-cloak>
								{{$currency_symbol}}@{{(vehicle_detail_toll_cost) | number: 2}}
							</div>
						</div>

						<div class="row">
							<div class="col-md-8">
								Surcharge <i class="fa fa-info-circle" title="@{{vehicle_detail_location_name}}"></i> : 
							</div>
							<div class="col-md-4" ng-cloak>
								{{$currency_symbol}}@{{(vehicle_detail_surcharge_amount) | number: 2}}
							</div>
						</div>
