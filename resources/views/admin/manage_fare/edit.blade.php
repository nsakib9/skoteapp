        ...
        <div class="box box-info">
          ...
          <div class="box-body" ng-init="time_options={{ json_encode($time_options) }};day_options={{json_encode($day_options)}};">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="input_per_km" class="col-sm-3 control-label">Per Mile<em class="text-danger">*</em></label>

                  <div class="col-sm-6">
                    {!! Form::text('per_km', $result->per_km, ['class' => 'form-control', 'id' => 'input_per_km', 'placeholder' => 'Per Mile']) !!}
