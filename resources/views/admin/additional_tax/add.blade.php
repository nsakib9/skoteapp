  ...
  <div class="content-wrapper" ng-controller="help">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="additional_tax">Additional Tax</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Additional Tax Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/add_additional_tax', 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
               <div class="form-group">
                ...
                <div class="form-group">
                  <label for="input_question" class="col-sm-3 control-label">Tax Name<em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('tax_name','', ['class' => 'form-control', 'id' => 'input_question', 'placeholder' => 'Tax Name']) !!}
                    <span class="text-danger">{{ $errors->first('tax_name') }}</span>
                  </div>
                </div>

                 <div class="form-group">
                  <label for="input_question" class="col-sm-3 control-label">Value<em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                   <div class="input-group addm">
                  {!! Form::text('tax_value','', ['class' => 'form-control', 'id' => 'input_service_fee', 'placeholder' => 'Value']) !!}
                ...
                <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: array())}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}};" ng-cloak>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row" ng-repeat="translation in translations">
                      ...
                      <div class="form-group">
                        <label for="input_name_@{{$index}}" class="col-sm-3 control-label">Tax Name<em class="text-danger">*</em></label>
                        <div class="col-sm-6">
                          {!! Form::text('translations[@{{$index}}][name]', '@{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_@{{$index}}', 'placeholder' => 'Tax Name']) !!}
