      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => 'admin/edit_additional_tax/'.$result->id, 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('tax_name', $result->name, ['class' => 'form-control', 'id' => 'input_question', 'placeholder' => 'Tax Name']) !!}
                ...
                <div class="form-group">
                  ...
                  {!! Form::text('tax_value',$result->value, ['class' => 'form-control', 'id' => 'input_service_fee', 'placeholder' => 'Value']) !!}
