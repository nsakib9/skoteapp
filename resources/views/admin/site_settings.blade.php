			...
			<div class="col-md-8 col-sm-offset-2">
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="input_payment_currency" class="col-sm-3 control-label">
								...
								<span style="font-size: 12px;">
									Note : This currency must be same as your Payment currency
								</span>
							</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label">Driver Miles</label>
							<div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="input_update_loc_interval" class="col-sm-3 control-label"> Cancellation Fee Time Interval <i id="interval-tooltip" data-toggle="tooltip" data-html="true"  class="glyphicon  glyphicon-info-sign" title="Interval in Minutes to update cancellation Fee"></i> <em class="text-danger">*</em></label>
                            <div class="col-sm-6">
                                {!! Form::text('update_cancellation_interval', old('update_cancellation_interval',site_settings('update_cancellation_interval')), ['class' => 'form-control', 'id' => 'input_update_loc_interval', 'placeholder' => 'Update Cancellation Interval']) !!}
                                <span class="text-danger">{{ $errors->first('update_cancellation_interval') }}</span>
                            </div>
                        </div>
					</div>
