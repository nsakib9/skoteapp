        ...
        <div class="box box-info">
          ...
          <div class="box-body" ng-init="formatted_coords={{ json_encode(old('formatted_coords',$result->co_ordinates)) }};coordinates=[]">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label for="input_name" class="col-sm-3 control-label">Surcharge Amount<em class="text-danger">*</em></label>
              <div class="col-sm-6">
                {!! Form::text('surcharge_amount', $result->surcharge_amount, ['class' => 'form-control', 'id' => 'input_surcharge_amount', 'placeholder' => 'Surcharge Amount']) !!}
                <span class="text-danger">{{ $errors->first('surcharge_amount') }}</span>
              </div>
            </div>
