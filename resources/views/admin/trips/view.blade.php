...
<div class="content-wrapper">
	<section class="content-header">
		<h1 style="display: inline-block; ">  Manage Trips Details </h1>
			...
			<div class="col-md-8 offset-2">
				<div class="card card-danger">
					<div class="card-header shadow p-3 mb-5 bg-body rounded with-border">
						<h3 class="card-title">Trips Details</h3>
					</div>
					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="col-sm-8 col-sm-offset-1 form-control-static">
						...
						@if($result->status == trans('messages.home.cancel_payment'))
						<div class="form-group">
							<label class="col-sm-3 control-label">
								Cancelled Reason
							</label>
						...
						@if(LOGIN_USER_TYPE != 'company')
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-sm-offset-1 form-control-static">
									Yet, Driver does't enter his Payout details.
								</div>
							</div>
