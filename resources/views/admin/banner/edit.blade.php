...
<div class="content-wrapper" ng-controller="destination_admin">
	<section class="content-header">
		<h1 style="display: inline-block; "> Edit Banner </h1>
		<ol style=" float: right;" class="breadcrumb">
			<li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home </a></li>
			<li><a href="{{ url(LOGIN_USER_TYPE.'/rider') }}"> /Banner </a></li>
		...
		<div class="row">
			<div class="col-md-8 offset-2">
				<div class="card card-danger">
					...
					<form action="{{ url('admin/edit_banner', $banner->id)}}" method="post" enctype="multipart/form-data">
						@csrf
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="line_one" value="{{$banner->line_one}}" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="line_two" value="{{$banner->line_two}}" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
								<img src="{{url('/banner/'."$banner->banner_img")}}" width="70" alt="Image"/>
							</div>
						</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="button_one" value="{{$banner->button_one }}" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="button_two" value="{{ $banner->button_two }}" class="form-control">
