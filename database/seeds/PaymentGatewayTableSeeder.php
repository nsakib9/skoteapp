...
class PaymentGatewayTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('payment_gateway')->insert([
            ['name' => 'trip_default', 'value' => 'stripe', 'site' => 'Common'],
            ['name' => 'payout_methods', 'value' => 'stripe', 'site' => 'Common'],
            ['name' => 'is_enabled', 'value' => '0', 'site' => 'Cash'],
            ['name' => 'is_enabled', 'value' => '0', 'site' => 'Paypal'],
